...
from order_products_association import OrderProductsAssociationSchema
...
class Products(db.Model):
    ...
    orders = db.relationship('association',back_populates = 'product_id')
...
#OrderProductsAssociationSchema
